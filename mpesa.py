import requests#this module is a third party used for making HTTP requests
import datetime#this module provudes classes for working with dates and times
#this module provides functions to encode binary data to ascii characters using Base64 encoding and decode base64-encoded data back to originalbinary form
import base64
...
def stk_push(phone, amount):
    ...
    # Combine the above 3 variables into single variable called "data"
    ...
    #an API (Apllication Program interface) is a set of rules and protocols that allows ones software to iteract with another.Daraja helps our website to interact with the mpesa server